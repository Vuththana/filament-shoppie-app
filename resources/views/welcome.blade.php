...
<div class="relative m-10 flex w-[300px] flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md hover:shadow-lg hover:scale-110 duration-300">
  ...
  <div class="mt-4 px-5 pb-5">
    ...
    <a href="{{ url('checkout/' .$product->id) }}" class="flex items-center justify-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
